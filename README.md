...
**Intensity Normalization Note**
>The KITTI pretrained PointPillars model expects intensity values normalized to [0, 1].If your LiDAR publishes raw intensity (e.g., [0, 255]), normalize it before inference to avoid unstable detections.
